...
// NewSyncScheduler is a factory function to instantiate a new service scheduler
...
// NewMigrateScheduler is a factory function to instantiate a new batch scheduler
...
func (s *GenericScheduler) computeJobAllocs() error {
	...
	s.logger.Printf("[DEBUG] computeJobAllocs sched: %#v: %#v", s.eval, diff)
