...
const (
	...
	DefaultDC       = "dc1"
	DefaultSerfPort = 3002
)

// These are the protocol versions that Udup can understand
const (
	ProtocolVersionMin uint8 = 1
	ProtocolVersionMax       = 1
)

// ProtocolVersionMap is the mapping of Udup protocol versions
...
var (
	DefaultRPCAddr = &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 3001}
)
...
type Config struct {
	...
	// the RPCAddr is unspecified "0.0.0.0:3000", but this address must be
	// reachable
