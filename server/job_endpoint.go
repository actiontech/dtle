...
func (j *Job) Register(args *structs.JobRegisterRequest, reply *structs.JobRegisterResponse) error {
	...
	defer metrics.MeasureSince([]string{"udup", "job", "register"}, time.Now())
	...
	if err != nil {
		j.srv.logger.Printf("[ERR] udup.job: Register failed: %v", err)
		return err
	}
	...
	if err != nil {
		j.srv.logger.Printf("[ERR] udup.job: Eval create failed: %v", err)
		return err
	}
...
func (j *Job) Evaluate(args *structs.JobEvaluateRequest, reply *structs.JobRegisterResponse) error {
	...
	defer metrics.MeasureSince([]string{"udup", "job", "evaluate"}, time.Now())
...
func (j *Job) Deregister(args *structs.JobDeregisterRequest, reply *structs.JobDeregisterResponse) error {
	...
	defer metrics.MeasureSince([]string{"udup", "job", "deregister"}, time.Now())
	...
	if err != nil {
		j.srv.logger.Printf("[ERR] udup.job: Deregister failed: %v", err)
		return err
	}
...
func (j *Job) GetJob(args *structs.JobSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "job", "get_job"}, time.Now())
...
func (j *Job) List(args *structs.JobListRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "job", "list"}, time.Now())
...
func (j *Job) Allocations(args *structs.JobSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "job", "allocations"}, time.Now())
...
func (j *Job) Evaluations(args *structs.JobSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "job", "evaluations"}, time.Now())
...
func (j *Job) Plan(args *structs.JobPlanRequest, reply *structs.JobPlanResponse) error {
	...
	defer metrics.MeasureSince([]string{"udup", "job", "plan"}, time.Now())
