...
func (e *Eval) GetEval(args *structs.EvalSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "get_eval"}, time.Now())
...
func (e *Eval) Dequeue(args *structs.EvalDequeueRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "dequeue"}, time.Now())
...
func (e *Eval) Ack(args *structs.EvalAckRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "ack"}, time.Now())
...
func (e *Eval) Nack(args *structs.EvalAckRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "nack"}, time.Now())
...
func (e *Eval) Update(args *structs.EvalUpdateRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "update"}, time.Now())
...
func (e *Eval) Create(args *structs.EvalUpdateRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "create"}, time.Now())
...
func (e *Eval) Reblock(args *structs.EvalUpdateRequest, reply *structs.GenericResponse) error {
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "reblock"}, time.Now())
...
func (e *Eval) Reap(args *structs.EvalDeleteRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "reap"}, time.Now())
...
func (e *Eval) List(args *structs.EvalListRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "list"}, time.Now())
...
func (e *Eval) Allocations(args *structs.EvalSpecificRequest,
	...
	defer metrics.MeasureSince([]string{"udup", "eval", "allocations"}, time.Now())
