...
// PingUdupServer sends a Status.Ping message to the specified server and
// returns true if healthy, false if an error occurred
func (p *ConnPool) PingUdupServer(region string, apiMajorVersion int, s *rpcproxy.ServerEndpoint) (bool, error) {
	// Get a usable client
