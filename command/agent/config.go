...
type Config struct {
	...
	UdupConfig *server.Config `mapstructure:"-" json:"-"`
...
type ClientConfig struct {
	...
	// Reserved is used to reserve resources from being used by Udup. This can
	// be used to target a certain utilization or to prevent Udup from using a
...
// DevConfig is a Config that is used for dev mode of Udup.
