...
func TestBinlogCoordinates(t *testing.T) {
	c1 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00017", LogPos: 104}
	c2 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00017", LogPos: 104}
	c3 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00017", LogPos: 5000}
	c4 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00099", LogPos: 104}
	c5 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00012", LogPos: 5000}
	c6 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00012", LogPos: 104}
...
func TestBinlogCoordinatesAsKey(t *testing.T) {
	...
	c1 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00017", LogPos: 104}
	c2 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00022", LogPos: 104}
	c3 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00017", LogPos: 104}
	c4 := common.BinlogCoordinatesX{LogFile: "mysql2-bin.00017", LogPos: 222}
...
func TestBinlogCoordinates_String(t *testing.T) {
	...
	tests := []struct {
		...
		{"emptyLog", fields{}, ""},
		{"emptyGtid", fields{LogFile: "mysql2-bin.00017", LogPos: 104}, ""},
...
func TestBinlogCoordinates_IsEmpty(t *testing.T) {
	...
	tests := []struct {
		...
		{"gtidEmpty", fields{LogFile: "mysql2-bin.00017", LogPos: 104}, false},
		{"logFileEmpty", fields{GtidSet: "server_id:121"}, false},
		{"gtidEmpty", fields{LogFile: "mysql2-bin.00017"}, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			b := &common.BinlogCoordinatesX{
