...
#
GRANT REPLICATION SLAVE, REPLICATION CLIENT ON *.* TO 'repluser' IDENTIFIED BY 'replpwd';
GRANT SELECT, RELOAD, SHOW DATABASES, REPLICATION SLAVE, REPLICATION CLIENT  ON *.* TO 'udupuser' IDENTIFIED BY 'uduppwd';
