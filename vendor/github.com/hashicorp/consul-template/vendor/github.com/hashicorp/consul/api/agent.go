...
type AgentServiceCheck struct {
	...
	// a check is in the critical store for more than this configured value,
...
// PassTTL is used to set a TTL check to the passing store.
//
...
// WarnTTL is used to set a TTL check to the warning store.
//
// DEPRECATION NOTICE: This interface is deprecated in favor of UpdateTTL().
// The client interface will be removed in 0.8 or changed to use
// UpdateTTL()'s endpoint and the server endpoints will be removed in 0.9.
...
// FailTTL is used to set a TTL check to the failing store.
//
// DEPRECATION NOTICE: This interface is deprecated in favor of UpdateTTL().
// The client interface will be removed in 0.8 or changed to use
// UpdateTTL()'s endpoint and the server endpoints will be removed in 0.9.
