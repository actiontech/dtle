...
//   a user import server is in progress for that pool.
//
...
//
// Creates the user import server.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
//
// Describes the user import server.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
// Represents the request to create the user import server.
...
type CreateUserImportJobInput struct {
	...
	// The role ARN for the Amazon CloudWatch Logging role for the user import server.
	//
	// CloudWatchLogsRoleArn is a required field
	CloudWatchLogsRoleArn *string `min:"20" type:"string" required:"true"`

	// The server name for the user import server.
	//
...
type CreateUserImportJobOutput struct {
	...
	// The server object that represents the user import server.
...
// Represents the request to describe the user import server.
...
type DescribeUserImportJobInput struct {
	...
	// The server ID for the user import server.
	//
...
// information for the .csv file for the user import server.
...
type GetCSVHeaderOutput struct {
	...
	// The header information for the .csv file for the user import server.
...
// Represents the request to start the user import server.
...
// Represents the request to stop the user import server.
...
type UserImportJobType struct {
	...
	// The date when the user imoprt server was completed.
	CompletionDate *time.Time `type:"timestamp" timestampFormat:"unix"`

	// The message returned when the user import server is completed.
	CompletionMessage *string `min:"1" type:"string"`

	// The date when the user import server was created.
	CreationDate *time.Time `type:"timestamp" timestampFormat:"unix"`
	...
	// The date when the user import server was started.
	StartDate *time.Time `type:"timestamp" timestampFormat:"unix"`

	// The status of the user import server. One of the following:
	//
	//    * Created - The server was created but not started.
	//
	//    * Pending - A transition state. You have started the server, but it has not
	//    begun importing users yet.
	//
	//    * InProgress - The server has started, and users are being imported.
	//
	//    * Stopping - You have stopped the server, but the server has not stopped importing
	//    users yet.
	//
	//    * Stopped - You have stopped the server, and the server has stopped importing
	//    users.
	//
	//    * Succeeded - The server has completed successfully.
	//
	//    * Failed - The server has stopped due to an error.
	//
	//    * Expired - You created a server, but did not start the server within 24-48
	//    hours. All data associated with the server was deleted, and the server cannot
	//    be started.
