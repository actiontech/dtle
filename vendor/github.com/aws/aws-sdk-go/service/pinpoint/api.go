...
//
// Creates or updates an import server.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
func (c *Pinpoint) GetImportJobRequest(input *GetImportJobInput) (req *request.Request, output *GetImportJobOutput) {
	op := &request.Operation{
		Name:       opGetImportJob,
		HTTPMethod: "GET",
		HTTPPath:   "/v1/apps/{application-id}/jobs/import/{server-id}",
	}
...
//
// Returns information about an import server.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
type GetImportJobInput struct {
	...
	JobId *string `location:"uri" locationName:"server-id" type:"string" required:"true"`
}
...
type ImportJobRequest struct {
	...
	// The ID of the segment to update if the import server is meant to update an existing
	// segment.
	SegmentId *string `type:"string"`

	// A custom name for the segment created by the import server. Use if DefineSegment
	// is true.
...
type ImportJobResponse struct {
	...
	// The unique ID of the application to which the import server applies.
	ApplicationId *string `type:"string"`
	...
	// The date the import server completed in ISO 8601 format.
	CompletionDate *string `type:"string"`

	// The date the import server was created in ISO 8601 format.
	CreationDate *string `type:"string"`

	// The import server settings.
	...
	// The unique ID of the import server.
	Id *string `type:"string"`

	// The status of the import server.Valid values: CREATED, INITIALIZING, PROCESSING,
	// COMPLETING, COMPLETED, FAILING, FAILEDThe server status is FAILED if one or
	...
	// The total number of pieces that must be imported to finish the server. Each
	// piece is an approximately equal portion of the endpoints to import.
	TotalPieces *int64 `type:"integer"`

	// The number of endpoints that were processed by the import server.
	TotalProcessed *int64 `type:"integer"`

	// The server type. Will be Import.
