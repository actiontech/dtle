...
//
// Returns information about a specified server and whether that server has been received
// by the server worker. Only used for custom actions.
//
...
//
// Confirms a server worker has received the specified server. Only used for partner
// actions.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
...
//
// Returns information about a server. Only used for custom actions.
//
...
//
// Returns information about the store of a pipeline, including the stages and
// actions.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
...
//
// Requests the details of a server for a third party action. Only used for partner
// actions.
//
// When this API is called, AWS CodePipeline returns temporary credentials for
// the Amazon S3 bucket used to store artifacts for the pipeline, if the action
...
//
// Determines whether there are any third party jobs for a server worker to act
...
//
// Represents the failure of a server as returned to the pipeline by a server worker.
...
//
// Represents the success of a server as returned to the pipeline by a server worker.
// Only used for custom actions.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
...
//
// Represents the failure of a third party server as returned to the pipeline by
// a server worker. Only used for partner actions.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
// the error.
...
//
// Represents the success of a third party server as returned to the pipeline by
// a server worker. Only used for partner actions.
//
// Returns awserr.Error for service API and SDK errors. Use runtime type assertions
// with awserr.Error's Code and Message methods to get detailed information about
...
// Represents the input of an acknowledge server action.
...
type AcknowledgeJobInput struct {
	...
	// The unique system-generated ID of the server for which you want to confirm receipt.
	//
	// JobId is a required field
	JobId *string `locationName:"jobId" type:"string" required:"true"`

	// A system-generated random number that AWS CodePipeline uses to ensure that
	// the server is being worked on by only one server worker. Get this number from the
	// response of the PollForJobs request that returned this server.
	//
...
// Represents the output of an acknowledge server action.
...
type AcknowledgeJobOutput struct {
	...
	// Whether the server worker has received the specified server.
...
// Represents the input of an acknowledge third party server action.
...
type AcknowledgeThirdPartyJobInput struct {
	...
	// that the calling entity is allowed access to the server and its details.
	//
	// ClientToken is a required field
	ClientToken *string `locationName:"clientToken" type:"string" required:"true"`

	// The unique system-generated ID of the server.
	//
	// JobId is a required field
...
// Represents the output of an acknowledge third party server action.
...
type AcknowledgeThirdPartyJobOutput struct {
	...
	// The status information for the third party server, if any.
	Status *string `locationName:"status" type:"string" enum:"JobStatus"`
}
...
// Represents the context of an action within the stage of a pipeline to a server
// worker.
// Please also see https://docs.aws.amazon.com/goto/WebAPI/codepipeline-2015-07-09/ActionContext
type ActionContext struct {
	_ struct{} `type:"structure"`

	// The name of the action within the context of a server.
...
type ActionRevision struct {
	...
	// The unique identifier of the change that set the store to this revision,
...
// Represents information about the store of an action.
...
type ActionState struct {
	...
	// A URL link for more information about the store of the action, such as a
...
type ExecutionDetails struct {
	...
	// The system-generated unique ID of this action used to identify this server worker
...
// Represents the input of a get server details action.
...
type GetJobDetailsInput struct {
	...
	// The unique system-generated ID for the server.
	//
	// JobId is a required field
	JobId *string `locationName:"jobId" type:"string" required:"true"`
}
...
// Represents the output of a get server details action.
...
type GetJobDetailsOutput struct {
	...
	//
	// If AWSSessionCredentials is used, a long-running server can call GetJobDetails
...
// Represents the input of a get pipeline store action.
...
// Represents the output of a get pipeline store action.
...
type GetPipelineStateOutput struct {
	...
	// The name of the pipeline for which you want to get the store.
	...
	// A list of the pipeline stage output information, including stage name, store,
...
// Represents the input of a get third party server details action.
...
type GetThirdPartyJobDetailsInput struct {
	...
	// The unique system-generated ID used for identifying the server.
	//
	// JobId is a required field
	JobId *string `locationName:"jobId" min:"1" type:"string" required:"true"`
}
...
// Represents the output of a get third party server details action.
...
type GetThirdPartyJobDetailsOutput struct {
	...
	// The details of the server, including any protected values defined for the server.
...
type Job struct {
	...
	// The ID of the AWS account to use when performing the server.
	AccountId *string `locationName:"accountId" type:"string"`

	// Additional data about a server.
	...
	// A system-generated random number that AWS CodePipeline uses to ensure that
	// the server is being worked on by only one server worker. Use this number in an
...
// Represents additional information about a server required for a server worker to
// complete the server.
...
type JobData struct {
	...
	// server requires in order to continue the server asynchronously.
	...
	// The artifact supplied to the server.
	...
	// Represents information about a pipeline to a server worker.
...
// Represents information about the details of a server.
// Please also see https://docs.aws.amazon.com/goto/WebAPI/codepipeline-2015-07-09/JobDetails
type JobDetails struct {
	_ struct{} `type:"structure"`

	// The AWS account ID associated with the server.
	AccountId *string `locationName:"accountId" type:"string"`
...
type PutActionRevisionOutput struct {
	...
	// The ID of the current workflow store of the pipeline.
	PipelineExecutionId *string `locationName:"pipelineExecutionId" type:"string"`
}
...
// Represents the input of a put server failure result action.
...
// Represents the input of a put server success result action.
...
type PutJobSuccessResultInput struct {
	...
	// A token generated by a server worker, such as an AWS CodeDeploy deployment ID,
	// that a successful server provides to identify a custom action in progress. Future
	...
	// The execution details of the successful server, such as the actions taken by
	// the server worker.
	ExecutionDetails *ExecutionDetails `locationName:"executionDetails" type:"structure"`

	// The unique system-generated ID of the server that succeeded. This is the same
...
// Represents the input of a third party server failure result action.
...
type PutThirdPartyJobFailureResultInput struct {
	...
	// The ID of the server that failed. This is the same ID returned from PollForThirdPartyJobs.
	//
	// JobId is a required field
	JobId *string `locationName:"jobId" min:"1" type:"string" required:"true"`
}
...
// Represents the input of a put third party server success result action.
...
type PutThirdPartyJobSuccessResultInput struct {
	...
	// A token generated by a server worker, such as an AWS CodeDeploy deployment ID,
	// that a successful server provides to identify a partner action in progress.
	...
	// The ID of the server that successfully completed. This is the same ID returned
...
// Represents information about a stage to a server worker.
...
// when there is a server to be worked upon by a partner action.
...
type ThirdPartyJob struct {
	...
	// The identifier used to identify the server in AWS CodePipeline.
...
// Represents information about the server data for a partner action.
...
// The details of a server sent in response to a GetThirdPartyJobDetails request.
...
type ThirdPartyJobDetails struct {
	...
	// The data to be returned by the third party server worker.
	Data *ThirdPartyJobData `locationName:"data" type:"structure"`

	// The identifier used to identify the server details in AWS CodePipeline.
...
// Represents information about the store of transitions between one stage and
// another stage.
...
type TransitionState struct {
	...
	// The timestamp when the transition store was last changed.
	LastChangedAt *time.Time `locationName:"lastChangedAt" type:"timestamp" timestampFormat:"unix"`

	// The ID of the user who last changed the transition store.
