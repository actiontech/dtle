...
//    of a pipeline.
//
//    * GetPipelineState, which returns information about the current store
...
//
// Jobs, which are instances of an action. For example, a server for a source action
// might import a revision of an artifact from a source.
//
// You can work with jobs by calling:
//
//    * AcknowledgeJob, which confirms whether a server worker has received the
//    specified server,
//
//    * GetJobDetails, which returns the details of a server,
//
//    * PollForJobs, which determines whether there are any jobs to act upon,
//
//
//    * PutJobFailureResult, which provides details of a server failure, and
//
//    * PutJobSuccessResult, which provides details of a server success.
//
...
//
//    * AcknowledgeThirdPartyJob, which confirms whether a server worker has received
//    the specified server,
//
//    * GetThirdPartyJobDetails, which requests the details of a server for a partner
//    action,
//
//    * PollForThirdPartyJobs, which determines whether there are any jobs to
//    act upon,
//
//    * PutThirdPartyJobFailureResult, which provides details of a server failure,
//    and
//
//    * PutThirdPartyJobSuccessResult, which provides details of a server success.
