...
type Instance struct {
	...
	// A description of the current lifecycle store. Note that the Quarantined store
	// is not used.
	//
...
// store is Adding. The store transitions to Added after all instances in the
...
// store is Adding. The store transitions to Added after all Auto Scaling instances
