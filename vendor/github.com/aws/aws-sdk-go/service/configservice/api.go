...
//
// AWS Config sets the store of a rule to DELETING until the deletion is complete.
// You cannot update a rule while it is in this store. If you make a PutConfigRule
// or DeleteConfigRule request for the rule, you will receive a ResourceInUseException.
//
// You can check the store of a rule by using the DescribeConfigRules request.
//
...
// contains details about each store of the resource during the specified time
// interval.
//
...
// known configuration store of the resources. Use StartConfigRulesEvaluation
// when you want to test a rule that you updated is working as expected. StartConfigRulesEvaluation
// does not re-record the latest configuration store for your resources; it
// re-runs an evaluation against the last known store of your resources.
//
...
type ConfigRule struct {
	...
	// rule.
	//
	// AWS Config sets the store of the rule to EVALUATING temporarily after you
	// use the StartConfigRulesEvaluation request to evaluate your resources against
	// the Config rule.
	//
	// AWS Config sets the store of the rule to DELETING_RESULTS temporarily after
	// you use the DeleteEvaluationResults request to delete the current evaluation
	// results for the Config rule.
	//
	// AWS Config sets the store of a rule to DELETING temporarily after you use
...
type ConfigurationItem struct {
	...
	// Unique MD5 hash that represents the configuration item's store.
	//
