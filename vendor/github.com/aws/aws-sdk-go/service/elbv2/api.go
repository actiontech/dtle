...
//
// Modifies the health checks used when evaluating the health store of the targets
...
// running store when you register it.
//
...
type LoadBalancer struct {
	...
	// The store of the load balancer.
...
// Information about the store of the load balancer.
// Please also see https://docs.aws.amazon.com/goto/WebAPI/elasticloadbalancingv2-2015-12-01/LoadBalancerState
type LoadBalancerState struct {
	_ struct{} `type:"structure"`

	// The store code. The initial store of the load balancer is provisioning. After
	// the load balancer is fully set up and ready to route traffic, its store is
	// active. If the load balancer could not be set up, its store is failed.
...
type TargetGroupAttribute struct {
	...
	//    Balancing to wait before changing the store of a deregistering target
...
type TargetHealth struct {
	...
	// store is healthy, a description is not provided.
	Description *string `type:"string"`

	// The reason code. If the target store is healthy, a reason code is not provided.
	//
	// If the target store is initial, the reason code can be one of the following
	// values:
	//
	...
	//
	// If the target store is unhealthy, the reason code can be one of the following
	// values:
	//
	...
	//
	// If the target store is unused, the reason code can be one of the following
	// values:
	//
	...
	//    balancer.
	//
	//    * Target.InvalidState - The target is in the stopped or terminated store.
	//
	// If the target store is draining, the reason code can be the following value:
	//
