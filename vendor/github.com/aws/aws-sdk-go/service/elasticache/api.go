...
//
// If the cluster is in the creating store, only cluster-level information is
// displayed until all of the nodes are successfully provisioned.
//
// If the cluster is in the deleting store, only cluster-level information is
// displayed.
//
...
// until they are completely provisioned. When the cache cluster store is available,
...
type CacheCluster struct {
	...
	// The current store of this cache cluster, one of the following values: available,
...
type CacheNode struct {
	...
	// The current store of this cache node.
...
type NodeGroup struct {
	...
	// The current store of this replication group - creating, available, etc.
	Status *string `type:"string"`
}
...
type NotificationConfiguration struct {
	...
	// The current store of the topic.
...
type ReplicationGroup struct {
	...
	// The current store of this replication group - creating, available, modifying,
...
type ReservedCacheNode struct {
	...
	// The store of the reserved cache node.
