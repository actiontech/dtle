...
//   You can't perform the operation on the handshake in its current store. For
...
//   The specified handshake is already in the requested store. For example, you
...
//
// Cancels a handshake. Canceling a handshake sets the handshake store to CANCELED.
//
...
//
// Declines a handshake request. This sets the handshake store to DECLINED and
...
type DeclineHandshakeOutput struct {
	...
	// A structure that contains details about the declined handshake. The store
...
type Handshake struct {
	...
	// The current store of the handshake. Use the store to trace the flow of the
	...
	//    The request stays in this store until all recipients respond.
	//
