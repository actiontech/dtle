...
type RunTaskInput struct {
	...
	// trigger a task to run a batch process server, you could apply a unique identifier
	// for that server to your task with the startedBy parameter. You can then identify
	// which tasks belong to that server by filtering the results of a ListTasks call
...
type Task struct {
	...
	// the PENDING store to the RUNNING store).
	...
	// the RUNNING store to the STOPPED store).
