...
//    registered, is in a deprecated store, or the decision is not properly
//    configured.
...
// which might put the workflow execution in an unstable store The cause field
...
type WorkflowTypeInfo struct {
	...
	// If the type is in deprecated store, then it is set to the date when the type
	// was deprecated.
	DeprecationDate *time.Time `locationName:"deprecationDate" type:"timestamp" timestampFormat:"unix"`
