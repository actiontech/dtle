...
// store until the deactivation process completes.
//
...
// includes the name of the pipeline, the pipeline identifier, its current store,
...
//
// The pipeline is in a FINISHED store.
...
type DeactivatePipelineInput struct {
	...
	// sets the store of any running objects to CANCELED. If this value is false,
