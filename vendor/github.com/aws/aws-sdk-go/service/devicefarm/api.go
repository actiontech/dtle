...
// Represents a request to the get server operation.
...
// Represents the result of a get server request.
// Please also see https://docs.aws.amazon.com/goto/WebAPI/devicefarm-2015-06-23/GetJobResult
type GetJobOutput struct {
	_ struct{} `type:"structure"`

	// An object containing information about the requested server.
	Job *Job `locationName:"server" type:"structure"`
}
...
type Job struct {
	...
	// Represents the total (metered or unmetered) minutes used by the server.
	DeviceMinutes *DeviceMinutes `locationName:"deviceMinutes" type:"structure"`

	// A message about the server's result.
	Message *string `locationName:"message" type:"string"`
...
type Problem struct {
	...
	// Information about the associated server.
	Job *ProblemDetail `locationName:"server" type:"structure"`
