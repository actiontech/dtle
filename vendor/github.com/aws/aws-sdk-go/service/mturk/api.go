...
//
// You can only dispose of HITs that are in the Reviewable store, with all of
// their submitted assignments already either approved or rejected. If you call
// the DeleteHIT operation on a HIT that is not in the Reviewable store (for
...
// may optionally store that a Worker must have the Qualification in order to
// preview the HIT.
