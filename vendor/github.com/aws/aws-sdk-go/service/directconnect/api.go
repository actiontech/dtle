...
// then, the virtual interface will be in 'Confirming' store, and will not be
...
// has been completed, the virtual interface will be in 'Confirming' store,
...
//
// Upon creation, the hosted connection is initially in the 'Ordering' store,
// and will remain in this store until the owner calls ConfirmConnection to
...
type BGPPeer struct {
	...
	// The store of the BGP peer.
	//
	//    * Verifying: The BGP peering addresses or ASN require validation before
	//    the BGP peer can be created. This store only applies to BGP peers on a
	//    public virtual interface.
	//
	//    * Pending: The BGP peer has been created, and is in this store until it
	...
	// The Up/Down store of the BGP peer.
	//
...
type ConfirmConnectionOutput struct {
	...
	//
	//    * Ordering: The initial store of a hosted connection provisioned on an
	//    interconnect. The connection stays in the ordering store until the owner
	//    of the hosted connection confirms or declines the connection order.
	//
	//    * Requested: The initial store of a standard connection. The connection
	//    stays in the requested store until the Letter of Authorization (LOA) is
	...
	//
	//    * Rejected: A hosted connection in the 'Ordering' store will enter the
	//    'Rejected' store if it is deleted by the end customer.
...
type ConfirmPrivateVirtualInterfaceOutput struct {
	...
	//    then the virtual interface will remain in this store until it is confirmed
	//    by the virtual interface owner.
	//
	//    * Verifying: This store only applies to public virtual interfaces. Each
	//    public virtual interface needs validation before the virtual interface
	//    can be created.
	//
	//    * Pending: A virtual interface is in this store from the time that it
	...
	//
	//    * Deleting: A virtual interface is in this store immediately after calling
	//    DeleteVirtualInterface until it can no longer forward traffic.
	//
	//    * Deleted: A virtual interface that cannot forward traffic.
	//
	//    * Rejected: The virtual interface owner has declined creation of the virtual
	//    interface. If a virtual interface in the 'Confirming' store is deleted
...
type DeleteInterconnectOutput struct {
	...
	//
	//    * Requested: The initial store of an interconnect. The interconnect stays
	//    in the requested store until the Letter of Authorization (LOA) is sent
	//    to the customer.
	//
...
type Lag struct {
	...
	// The store of the LAG.
	//
	//    * Requested: The initial store of a LAG. The LAG stays in the requested
	//    store until the Letter of Authorization (LOA) is available.
	//
	...
	// below this setting, the LAG store changes to down. This value can help to
...
type VirtualGateway struct {
	...
	//
	//    * Pending: This is the initial store after calling CreateVpnGateway.
	//
	//    * Available: Ready for use by a private virtual interface.
	//
	//    * Deleting: This is the initial store after calling DeleteVpnGateway.
	//
	//    * Deleted: In this store, a private virtual interface is unable to send
