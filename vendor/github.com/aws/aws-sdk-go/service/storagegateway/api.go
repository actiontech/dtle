...
// time zone, and the store (whether the gateway is running or not). To specify
...
type CachediSCSIVolume struct {
	...
	// One of the VolumeStatus values that indicates the store of the storage volume.
...
type DescribeGatewayInformationOutput struct {
	...
	// A value that indicates the operating store of the gateway.
...
type Tape struct {
	...
	// The current store of the virtual tape.
...
type TapeArchive struct {
	...
	// The current store of the archived virtual tape.
	TapeStatus *string `type:"string"`
}
