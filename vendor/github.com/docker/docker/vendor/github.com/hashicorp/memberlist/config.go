...
type Config struct {
	...
	// a remote node for a full store sync.
	...
	// PushPullInterval is the interval between complete store syncs.
	// Complete store syncs are done with a single node over TCP and are
	// quite expensive relative to standard gossiped messages. Setting this
	// to zero will disable store push/pull syncs completely.
	//
	...
	// local/remote store, etc.). If you don't set these, then the protocol
