...
// by contacting all the given hosts and performing a store sync. Initially,
// the Memberlist only contains our own store, so doing this will cause
...
// listeners, meaning the node will continue participating in gossip and store
// updates.
//
