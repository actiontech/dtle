...
// task to ALLOCATED store. Since a task can move to ALLOCATED store
...
// voted then the task is moved to ALLOCATED store.
//
// Other than the coordination needed for task ALLOCATED store, all
