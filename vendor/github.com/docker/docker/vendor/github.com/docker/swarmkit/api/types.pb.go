...
type NodeStatus struct {
	State   NodeStatus_State `protobuf:"varint,1,opt,name=store,proto3,enum=docker.swarmkit.v1.NodeStatus_State" json:"store,omitempty"`
...
type UpdateStatus struct {
	...
	State UpdateStatus_UpdateState `protobuf:"varint,1,opt,name=store,proto3,enum=docker.swarmkit.v1.UpdateStatus_UpdateState" json:"store,omitempty"`
...
type TaskStatus struct {
	...
	State TaskState `protobuf:"varint,2,opt,name=store,proto3,enum=docker.swarmkit.v1.TaskState" json:"store,omitempty"`
...
type IssuanceStatus struct {
	State IssuanceStatus_State `protobuf:"varint,1,opt,name=store,proto3,enum=docker.swarmkit.v1.IssuanceStatus_State" json:"store,omitempty"`
