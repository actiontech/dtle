...
// store. Store exposes a transactional interface for both reads and writes.
...
// store. Similarly, Update accepts a callback function that it will invoke with
...
// maintaining their own copies of the store.
package state
