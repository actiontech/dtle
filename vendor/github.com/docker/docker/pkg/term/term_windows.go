...
// SaveState saves the store of the terminal connected to the given file descriptor.
...
func DisableEcho(fd uintptr, state *State) error {
	...
	// Register an interrupt handler to catch and restore prior store
	restoreAtInterrupt(fd, state)
	return nil
}

// SetRawTerminal puts the terminal connected to the given file descriptor into
// raw mode and returns the previous store. On UNIX, this puts both the input
...
// store. On Windows, it disables LF -> CRLF translation.
...
// mode and returns the previous store of the terminal so that it can be restored.
