...
func (b *EvalBroker) Enqueue(eval *models.Evaluation) error {
	b.l.Lock()
	defer b.l.Unlock()
...
func (b *EvalBroker) enqueueLocked(eval *models.Evaluation) error {
	...
	if !ok {
		pending = make([]*models.Evaluation, 16)
...
func (b *EvalBroker) Dequeue(schedulers []string, timeout time.Duration) (*models.Evaluation, error) {
...
func (b *EvalBroker) scanForSchedulers(schedulers []string) (*models.Evaluation, error) {
	b.l.Lock()
	defer b.l.Unlock()
...
func (b *EvalBroker) dequeueForSched(sched string) (*models.Evaluation, error) {
	// Get the pending queue
